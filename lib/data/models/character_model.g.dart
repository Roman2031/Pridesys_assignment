...
class LocalEditModelAdapter extends TypeAdapter<LocalEditModel> {
  @override
  final int typeId = 1;

  @override
  LocalEditModel read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
  ...
  @override
  void write(BinaryWriter writer, LocalEditModel obj) {
    writer
      ..writeByte(9)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is LocalEditModelAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}
